...
class _HomeListeningState extends State<HomeListening> {
  ...
  String get durationText => _duration != null
      ? '${_duration!.inMinutes}:${(_duration!.inSeconds % 60).toString().padLeft(2, '0')}'
      : '00:00';

  String get positionText => _position != null
  ...
  void _changeSpeed() {
    ...
    else if (_playbackSpeed == 2.0) newSpeed = 0.75;
    else newSpeed = 1.0;
                    ...
                    children: [
                      Container(
                        ...
                        child: Image.asset(
                          ...
                          const Icon(Icons.multitrack_audio, color: Color(0xFF8D7542)),
                        ),
                      ),
                    ...
                    Stack(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: const Color(0xFFF5E9B9), // Màu vàng nhạt của bìa sách
                                  ...
                                  errorBuilder: (context, error, stackTrace) =>
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Icon(Icons.nature, size: 80, color: Colors.brown.withOpacity(0.7)),
  ...
  Widget _buildFeatureButton(IconData icon, String label, {bool hasCircle = true, VoidCallback? onTap}) {
        ...
        content: SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final isCurrentChapter = chapterNumber == 10; // Giả sử đang ở chương 10

              return ListTile(
                title: Text('Chương $chapterNumber'),
                subtitle: Text('Phần ${chapterNumber % 3 == 0 ? "cuối" : chapterNumber % 3 == 1 ? "đầu" : "giữa"}'),
