...
class _OnboardingScreenOneState extends State<OnboardingScreenOne> {
  ...
  final List<Map<String, dynamic>> categories = [
    {'name': 'Phát triển bản thân', 'icon': Icons.local_florist, 'selected': false},
    {'name': 'Kinh doanh & Đầu tư', 'icon': Icons.monetization_on, 'selected': false},
    {'name': 'Tiểu thuyết & Truyện', 'icon': Icons.book, 'selected': false},
    {'name': 'Sức khỏe & Phong cách sống', 'icon': Icons.favorite, 'selected': false},
    {'name': 'Khoa học & Xã hội', 'icon': Icons.science, 'selected': false},
    {'name': 'Tôn giáo & Tâm linh', 'icon': Icons.spa, 'selected': false},
    {'name': 'Gia đình & Trẻ em', 'icon': Icons.family_restroom, 'selected': false},
  ];

  // Biến để kiểm tra xem có ít nhất một chủ đề được chọn hay không
  bool get hasSelectedTopics => categories.any((item) => item['selected'] == true);
